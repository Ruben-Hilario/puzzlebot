...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/models/Map_DT', glob('models/Map_DT/*.*')),
        ('share/' + package_name + '/models/Map_DT/meshes', glob('models/Map_DT/meshes/*')),
        ('share/' + package_name + '/models/rack', glob('models/rack/*.*')),
        ('share/' + package_name + '/models/rack/meshes', glob('models/rack/meshes/*')),
    ],
